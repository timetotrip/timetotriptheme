...
function putH1Index($title){
    ...
    $div .= '<div class="hl-title  sdw_card">'
                .'<div class="hlt-back ptn-str-brown"></div>';
        
        if ($title != ""):
        
        $div .= '<div class="hlt-name">'
                            .'<i class="fab fa-gripfire ptn-txgrad-fire"></i>'
                            .'<h1 >'. $title .'</h1> '
                            .'<i class="fab fa-gripfire ptn-txgrad-fire"></i>';
        else:
        $div .= '<div class="hlt-name hlt-spb">'
                            .'<i class="fab fa-gripfire ptn-txgrad-fire"></i>'
                            .'<i class="fab fa-gripfire ptn-txgrad-fire"></i>';
        endif;
        $div .= '</div>'
